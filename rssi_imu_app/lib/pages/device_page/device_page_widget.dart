...
class DevicePageWidget extends StatefulWidget {
  ...
  final String? deviceMagnetometer;
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        ...
        _model.value = widget.deviceMagnetometer;
      });
      _model.rssiUpdateTimer = InstantTimer.periodic(
        duration: Duration(milliseconds: 2000),
        callback: (timer) async {
          _model.newRssi = await actions.getRssi(
            BTDevicesStruct(
          ...
          _model.magnetometerData = await actions.getMagnetometerEvent();
          setState(() {
            _model.currentRssi = _model.newRssi;
            _model.value = _model.magnetometerData;
          });
