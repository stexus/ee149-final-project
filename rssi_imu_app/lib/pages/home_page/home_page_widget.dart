                ...
                children: [
                  ...
                  Switch.adaptive(
                    ...
                    onChanged: (newValue) async {
                      ...
                      if (newValue!) {
                        _model.turnOn = await actions.bluetoothOn();
                        ...
                        _model.toggledConnectedDevices =
                            await actions.getConnectedDevices();
                        setState(() {
                          _model.isFetchingConnectedDevices = false;
                          _model.connectedDevices = _model
                              .toggledConnectedDevices!
                              .toList()
                              .cast<BTDevicesStruct>();
                        });
                        _model.toggledDevices = await actions.findDevices();
                        setState(() {
                          _model.isFetchingDevices = false;
                          _model.foundDevices = _model.toggledDevices!
                              .toList()
                              .cast<BTDevicesStruct>();
                        });
                        ...
                        _model.turnOff = await actions.bluetoothOff();
                        setState(() {
